...
import ChangePasswordTabs from "pages/Pages/Settings/ChangePasswordTabs";
import PersonalTabs from "pages/Pages/Settings/PersonalTabs";


const EditAccount = () => {
    return (
        <React.Fragment>
            <BreadCrumb title='Edit' pageTitle='Account' />
            <Tab.Container defaultActiveKey="personalTabs">
                <div className="card">
                    <TopAccountInfo className="card-body" />
