...
const DropdownUser = () => {
  ...
  const [userAttributes, setUserAttributes] = useState<CustomUserAttributes | null>(null);

  async function handleFetchUserAtttributes(){
    try{
      ...
      >
        <span className="hidden text-right lg:block">
          <span className="block text-sm font-medium text-black dark:text-white">
            {userAttributes ? userAttributes.family_name : "Nom"} {userAttributes ? userAttributes.given_name : "Nom"}
          </span>
          {/* <span className="block text-xs">{userAttributes ? userAttributes.email : "Nom"}</span> */}
          <span className="block text-xs">{userAttributes && userAttributes['custom:job'] ? userAttributes['custom:job'] : "Nom"}</span>
