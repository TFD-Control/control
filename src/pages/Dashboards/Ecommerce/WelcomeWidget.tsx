...
const WelcomeWidget = () => {
    ...
    const [user, setUser] = useState<UserTwo | null>(null);
    ...
    useEffect(() => {
        const fetchUserData = async () => {
            ...
            if (authUser) {
                try {
                    const userData = await getUserFirestore(authUser.uid);
                    setUser(userData);
                } catch (err) {
                ...
                <div className="relative card-body">
                    <div className="grid items-center grid-cols-12">
                        <div className="col-span-12 lg:col-span-8 2xl:col-span-7">
                            <h5 className="mb-3 font-normal tracking-wide text-slate-200">Welcome {user.firstName} 🎉</h5>
